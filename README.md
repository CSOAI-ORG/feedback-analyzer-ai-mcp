...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/feedback_analyzer_ai_mcp/)
...
- [Full Documentation](https://docs.meok.ai/feedback-analyzer-ai-mcp)
...
- "Use `analyze_feedback` to …"
- "Use `extract_themes` to …"
- "Use `sentiment_trend` to …"
